...
--
-- Host: 127.0.0.1    Database: dbcardapio
-- ------------------------------------------------------
...
CREATE TABLE `tb_cardapio` (
  ...
  `descCarneA` varchar(255) DEFAULT NULL,
  `descCarneB` varchar(255) DEFAULT NULL,
  `descPrato` varchar(255) DEFAULT NULL,
  `descSaladaA` varchar(255) DEFAULT NULL,
  `descSaladaB` varchar(255) DEFAULT NULL,
  `descSuco` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2017-01-26 15:11:15
